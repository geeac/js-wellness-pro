...
function wellness_enqueue_scripts_styles() {
	...
	wp_enqueue_style( 'wellness-fonts', '//fonts.googleapis.com/css?family=Alice|Cabin:400,600', array(), CHILD_THEME_VERSION );
...
add_image_size( 'thumbnail-large', 320, 320, TRUE );
